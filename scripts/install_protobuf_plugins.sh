...
# documentation for your gRPC services. Use this when you need to create API
# documentation that can be consumed by tools like Swagger UI.
...
# protoc-gen-go is used to generate Go code from your .proto files. This
